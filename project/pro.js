...
function addToCart(id) {
    ...
    updateCartCount();   // header updates only here
}
...
function changeQty(id, value) {
    ...
    displayCart();
    checkEmptyCart();   // ← immediate update when last item removed
}
...
function loadCart() {
    ...
    emptyMsg.style.display = "none"; // hide message if items exist
